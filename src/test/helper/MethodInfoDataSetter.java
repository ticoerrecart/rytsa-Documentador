...
import test.model.MethodInfo;
import static test.util.CodeAnalyzerConstants.*;
...
public class MethodInfoDataSetter {
	...
	/**
	 * Set the attributes of the currently visiting method to the java class
	 * model
	 * 
	 * @param clazzInfo
	...
	public static void populateMethodInfo(JavaClassInfo clazzInfo,
		...
		LocationInfo locationInfo = DataSetterUtil.getLocationInfo(trees, path,
				methodTree);
